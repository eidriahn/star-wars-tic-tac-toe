        ...
        {board.map((cell, index) => (
          <button
            ...
            class={clsx(
              ...
              'border-2 bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-sm',
              'shadow-inner',
              {
                'border-blue-400/60 hover:border-yellow-400 hover:scale-105 hover:bg-white/20 cursor-pointer': !cell && !disabled,
            ...
            style={{
              boxShadow: winningCells?.includes(index)
                ...
                : cell
                  ? `inset 0 0 15px ${cell === 'X' ? 'rgba(79, 195, 247, 0.2)' : 'rgba(255, 23, 68, 0.2)'}`
