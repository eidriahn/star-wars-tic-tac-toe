  ...
  return (
    <div class="fixed inset-0 flex items-center justify-center p-4">
      ...
      <div class="relative max-w-md w-full animate-[scale-in_0.3s_ease-out]">
        <div
          class={clsx(
            'bg-gradient-to-br rounded-2xl p-8 text-center',
            'border-4 shadow-2xl',
            {
              'from-blue-900/90 to-blue-600/90 border-blue-400': winner === 'X',
        ...
        >
          ...
          <div class="mb-6">
            {isDraw ? (
              <div>
                <div class="text-7xl font-bold font-mono mb-2 text-gray-400" style="text-shadow: 0 0 15px #9e9e9e, 0 0 30px #9e9e9e">=</div>
